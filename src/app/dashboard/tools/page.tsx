      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {canEdit && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#0c2461] hover:bg-[#1e3799] text-white text-xs font-semibold shadow-sm transition-all cursor-pointer w-fit"
          >
