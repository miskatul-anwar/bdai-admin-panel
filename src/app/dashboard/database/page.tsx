  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-xs border border-slate-200 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5 w-full md:w-auto">
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-semibold rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 transition-colors cursor-pointer disabled:opacity-50 flex-1 sm:flex-initial"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 text-xs font-semibold rounded-xl bg-[#0c2461] hover:bg-[#0c2461]/90 text-white shadow-xs transition-colors cursor-pointer flex-1 sm:flex-initial"
          >
      ...
      <div className="bg-white rounded-2xl p-5 shadow-xs border border-slate-200 space-y-4">
        ...
        {/* Data Table */}
        <div className="overflow-x-auto border border-slate-200 rounded-xl no-scrollbar overscroll-contain">
